...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Simon Potye"
    user-mail-address "2350859+ottnorml@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/spt/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/spt/bin" "/profile/bin" "/Users/spt/.npm-packages/bin" "/Users/spt/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
